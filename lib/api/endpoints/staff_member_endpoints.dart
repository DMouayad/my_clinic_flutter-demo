...
part 'src/staff_members/add_staff_member_endpoint.dart';
part 'src/staff_members/update_staff_member_endpoint.dart';
part 'src/staff_members/fetch_staff_members_endpoint.dart';
part 'src/staff_members/delete_staff_member_endpoint.dart';
